 ...
 168              	.LFB3:
  49:x86.c         **** 
  50:x86.c         **** int func3(enum flavors t) {
 169              		.loc 1 50 0
 170              		.cfi_startproc
 ...
 192      000000
  56:x86.c         **** 			break;
 193              		.loc 1 56 0
 194 00ec EB22     		jmp	.L18	#
 195              	.L14:
  57:x86.c         **** 		case chocolate:
  58:x86.c         **** 			like = 7;
 196              		.loc 1 58 0
 197 00ee C745FC07 		movl	$7, -4(%rbp)	#, like
 197      000000
  59:x86.c         **** 			break;
 198              		.loc 1 59 0
 199 00f5 EB19     		jmp	.L18	#
 200              	.L16:
  60:x86.c         **** 		case strawberry:
  61:x86.c         **** 			like = -6;
 201              		.loc 1 61 0
 202 00f7 C745FCFA 		movl	$-6, -4(%rbp)	#, like
 202      FFFFFF
  62:x86.c         **** 			break;
 203              		.loc 1 62 0
 204 00fe EB10     		jmp	.L18	#
 205              	.L17:
  63:x86.c         **** 		case tuttifrutti:
  64:x86.c         **** 			like = 6;
 206              		.loc 1 64 0
 207 0100 C745FC06 		movl	$6, -4(%rbp)	#, like
 207      000000
  65:x86.c         **** 			break;
 208              		.loc 1 65 0
 209 0107 EB07     		jmp	.L18	#
 210              	.L20:
  66:x86.c         **** 		default :
  67:x86.c         **** 			like = -2;
 211              		.loc 1 67 0
 212 0109 C745FCFE 		movl	$-2, -4(%rbp)	#, like
 212      FFFFFF
 213              	.L18:
  68:x86.c         **** 	}
  69:x86.c         **** 	return like;
 214              		.loc 1 69 0
 215 0110 8B45FC   		movl	-4(%rbp), %eax	# like, _9
  70:x86.c         **** }
 216              		.loc 1 70 0
 217 0113 5D       		popq	%rbp	#
 218              		.cfi_def_cfa 7, 8
 219 0114 C3       		ret
 220              		.cfi_endproc
 221              	.LFE3:
 223              	.Letext0:
 224              		.file 2 "/usr/lib/gcc/x86_64-linux-gnu/6/include/stddef.h"
 225              		.file 3 "/usr/include/x86_64-linux-gnu/bits/types.h"
 226              		.file 4 "/usr/include/libio.h"
 227              		.file 5 "/usr/include/stdio.h"
 228              		.file 6 "/usr/include/x86_64-linux-gnu/bits/sys_errlist.h"
